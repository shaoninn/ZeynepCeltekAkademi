  ...
  return (
    <div>
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between mb-6">
        <div>
          <h1 className="font-display text-2xl sm:text-3xl font-bold">Eğitimler</h1>
          <p className="text-sm text-[#888] mt-1">
            Tabloda fiyat / kayıt durumu / aktiflik toplu güncelleyin veya Excel ile
            yükleyin. Detaylı görsel ve özellikler için eğitim detayına girin.
          </p>
        </div>
        <Link
