 ...
 */
export type EditableIconBoxActiveProps = EditableIconBoxProps;

/** Editor-only icon control — loaded via dynamic() when editor is enabled. */
export function EditableIconBoxActive({
  contentKey,
  sizeKey,
  iconUrl = "",
  iconSize = 22,
