...
export type EditableImageActiveProps = EditableImageProps;

/** Editor-only image control — loaded via dynamic() when editor is enabled. */
export function EditableImageActive({
  contentKey,
  value,
  fallback = "",
  alt,
  ...
  const { saveContent, saving } = useEditor();
