...
export function PaytrCheckoutButton({
    ...
    return (
      <div className="space-y-3">
        <p className="text-sm text-muted">
          Güvenli PayTR ödeme formu — kayıt ücreti {totalLabel}
        </p>
        <iframe
  ...
  return (
    <div className="space-y-3">
      ...
      >
        {loading ? "PayTR açılıyor…" : "Kart ile kayıt ücretini öde (PayTR)"}
      </button>
      <p className="text-xs text-muted">
        3D Secure ile PayTR üzerinden tahsil edilir. Ödeme sonucu kaydınıza
        otomatik işlenir; kontenjan teyidi için ekibimiz sizinle iletişime geçer.
      </p>
    </div>
  );
}
